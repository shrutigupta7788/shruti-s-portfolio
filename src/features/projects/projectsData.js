export default [
  ...
  },
  {
    ...
    description:
      "Professional corporate web platform for an accounting & tax consultancy firm, delivering clear service breakdowns, client inquiries, and custom contact forms.",
    image:
  ...
  },
  {
    ...
    description:
      "Interactive web showcase featuring immersive 3D scene rendering with Spline, custom keyframe animations, and responsive UI controls.",
    image:
      "https://res.cloudinary.com/dbqgtkyyq/image/upload/v1755614308/3D_Website_eagnb9.png",
    techStack: ["HTML", "CSS", "Spline", "JavaScript"],
    liveLink: "https://three-d-project-one.vercel.app/",
    githubLink: "https://github.com/shrutigupta7788",
    featured: false,
  },
  {
    title: "Animated Interactive Web Application",
    description:
